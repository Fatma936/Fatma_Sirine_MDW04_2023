                        ...
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">List assigned admin</li>
                                </ol><th></th>
                            </nav>
                        </div>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body"> Are you sure you want to delete this site associated to:
                                                                    <br/><?php echo e(ucfirst($site->admin_names)); ?> ?</div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cancel</button>
                                                                    <form id="deleteForm<?php echo e($site->id); ?>" action="<?php echo e(url('destroy-record/'.$site->site_id)); ?>" method="POST">
                                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/douz/Downloads/projetPFE2/resources/views/Site-user/list_affectation.blade.php ENDPATH**/ ?>