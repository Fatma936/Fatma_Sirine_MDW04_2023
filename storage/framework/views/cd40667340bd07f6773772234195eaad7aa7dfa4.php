                        ...
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">List of assigned site to device</li>
                                </ol><th></th>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="card border-top border-0">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0">Assigned site to device:</h5>
                            </div>
                            <hr>   
                            ...
                            <div class="alert border-0 border-start border-5 border-success alert-dismissible fade show py-2">
                             ...
                             <div class="d-flex align-items-center">
                                 <div>
                                     <a href="affect_site_device" class="btn btn-primary">Assign site to device</a>
                                    </div>
                                </div>
                                <div class="table-responsive mt-3">
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                <?php if($site->device_id == "ffffff100000b745"): ?>
                                                AN-103A Temp/Humidity Sensor
                                                <?php elseif($site->device_id == "ffffff100000c836"): ?>
                                                    ...
                                                    <div class="modal fade" id="deleteModal<?php echo e($site->id); ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel<?php echo e($site->id); ?>" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body"> Are you sure you want to delete site associated to:
                                                                    <br/><?php echo e(ucfirst($site->device_id)); ?> ?</div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cancel</button>
                                                                    <form id="deleteForm<?php echo e($site->id); ?>" action="<?php echo e(url('destroy-record-device',$site->id )); ?>" method="POST" >
                                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/douz/Downloads/projetPFE2/resources/views/device_site/list_affectation_of_site_devices.blade.php ENDPATH**/ ?>