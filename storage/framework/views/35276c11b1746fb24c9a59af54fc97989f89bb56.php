                            ...
                            <div class="alert border-0 border-start border-5 border-success alert-dismissible fade show py-2">
                             ...
                             <div class="d-flex align-items-center">
                                ...
                                <div class="table-responsive mt-3">
                                        ...
                                        <tbody>
                                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <td>                    
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="modal fade" id="deleteModal<?php echo e($site->id); ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel<?php echo e($site->id); ?>" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body"> Are you sure you want to delete this site associated to:
                                                                        <br/><?php echo e(ucfirst($site->name)); ?> ?</div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cancel</button>
                                                                        <form id="deleteForm<?php echo e($site->id); ?>" action="<?php echo e(url('destroy-record-user/'.$site->id)); ?>" method="POST">
                                                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/douz/Downloads/projetPFE2/resources/views/Sites-to-admin/list_site_of_admin.blade.php ENDPATH**/ ?>