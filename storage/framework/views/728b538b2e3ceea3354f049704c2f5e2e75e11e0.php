                ...
                <nav class="navbar navbar-expand">
                    ...
                    <div class="user-box dropdown">
                        ...
                        <?php if(auth()->user()->image !== null): ?>
                            <img src="<?php echo e(asset('storage/' . auth()->user()->image)); ?>" class="user-img" alt="user avatar">
                        <?php else: ?>
                        ...
                        <?php endif; ?>
                            ...
                            <div class="user-info ps-3">
                                ...
                                <p class="designattion mb-0"><?php echo e(Auth::user()->role); ?></p>
                            </div>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="<?php echo e(route('logout')); ?>"><i class='bx bx-log-out-circle'></i><span>Logout</span></a></li>
                        </ul>
                    </div>
                </nav>
            </div>
    ...
    <?php /**PATH /home/douz/Downloads/projetPFE2/resources/views/layouts/header.blade.php ENDPATH**/ ?>