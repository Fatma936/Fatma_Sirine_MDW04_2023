                        ...
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    <li class="breadcrumb-item"><a href="list-admin"><i class="bx bx-home-alt"></i></a>
                                    </li>
                    ...
                    <div class="card border-top border-0 border-4 border-success">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-success">Add New Admin:</h5>
                            </div>
                            <hr>
...
unset($__errorArgs, $__bag); ?>" name="name" id="inputLastName1" placeholder="Username" />
...
unset($__errorArgs, $__bag); ?>" name="email" id="inputEmailAddress" placeholder="your_mail@gmail.com" required/>
...
unset($__errorArgs, $__bag); ?>" name="password"  id="inputChoosePassword" placeholder="12345678" required> <a href="javascript:;" class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/douz/Downloads/projetPFE2/resources/views/admin/add-new-admin.blade.php ENDPATH**/ ?>