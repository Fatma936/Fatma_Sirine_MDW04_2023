                             ...
                             <?php endif; ?>
                                    ...
                                    <div class="table-responsive mt-3">
                                        ...
                                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <td> 
                                                    <div class="d-flex align-items-center">
                                                        <a class="btn btn-sm btn-primary" href="<?php echo e(url('edit-admin/'.$user->id)); ?>" ><i class='bx bx-edit-alt me-0'></i></a>
                                                        &nbsp;&nbsp;
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form id="deleteForm<?php echo e($user->id); ?>" action="<?php echo e(url('destroy-admin/'.$user->id)); ?>" method="POST">
                                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/douz/Downloads/projetPFE2/resources/views/admin/list_admin.blade.php ENDPATH**/ ?>