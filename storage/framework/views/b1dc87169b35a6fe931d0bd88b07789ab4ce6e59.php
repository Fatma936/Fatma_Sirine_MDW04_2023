                ...
                <div class="col-xl-7 mx-auto">
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            ...
                            <form class="row g-3" action="<?php echo e(url('update-admin/'.$user->id)); ?>" method="post">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                       ...
                                       <div class="col-12">
                                           ...
                                           <div class="input-group"> <span class="input-group-text bg-transparent"><i class='bx bxs-check-shield' ></i></span>
                                               <input type="text" class="form-control border-start-0" name="role" value="<?php echo e($user->role); ?>" readonly/>
                                           </div>
                                       </div>
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/douz/Downloads/projetPFE2/resources/views/admin/update-admin.blade.php ENDPATH**/ ?>