                ...
                <div class="col-xl-7 mx-auto">
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            ...
                            <form class="row g-3" action="<?php echo e(url('update-site/'.$site->id)); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                                  ...
                                  <div class="col-12">
                                           ...
                                           <div class="input-group"> <span class="input-group-text bg-transparent"><i class='bx bxs-map'></i></span>
                                               <input type="text" class="form-control border-start-0" name="location" value="<?php echo e($site->location); ?>" />
                                           </div>
                                       </div>
                                       <div class="col-12">
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/douz/Downloads/projetPFE2/resources/views/Site/update-site.blade.php ENDPATH**/ ?>