                        ...
                        <div class="main-body">
                            <div class="row">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex flex-column align-items-center text-center">
                                                ...
                                                <img src="<?php echo e(asset('storage/' . auth()->user()->image)); ?>" class="rounded-circle p-1 bg-primary" width="110">
                                                <?php else: ?>
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <p class="text-secondary mb-1"><?php echo e($profile->role); ?></p>
                                                    <br>
                                                    <form action="<?php echo e(url('updatePhoto')); ?>" method="POST" enctype="multipart/form-data">
                                                        <?php echo csrf_field(); ?>
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                                    ...
                                                    <span class="text-secondary"><?php echo e($profile->address); ?></span>
                                                </li>
                                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <div class="col-lg-8">
                                    <div class="card">
                                        <div class="card-body">
                                            <form action="<?php echo e(url('update-profile-user')); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <input type="text" class="form-control" value="<?php echo e($profile->email); ?>" disabled>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-sm-3">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <input type="text" class="form-control" name="address" value="<?php echo e($profile->address); ?>" required>
                                                    </div>
                                                </div>
                                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="tab-content" id="nav-tabContent">
                                                <div class="tab-pane fade show active" id="nav-admins" role="tabpanel" aria-labelledby="nav-admins-tab" tabindex="0">
                                                    <table class="table table-striped table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <span class="text-secondary"><?php echo e($admin->name); ?></span>
                                                                </td>
                                                                <td>
                                                                    <?php if($admin->image): ?>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    ?> 
                                                                    <?php if($site_admin->isNotEmpty()): ?>
                                                                        <?php $__currentLoopData = $site_admin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <span class="text-secondary">Site: <?php echo e($site->location); ?></span><br>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <?php if($adminUsers->isNotEmpty()): ?>
                                                                        <?php $__currentLoopData = $adminUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adminUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <span class="text-secondary"><?php echo e($adminUser->name); ?></span><br>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    <?php else: ?>
                                                ...
                                                <?php endif; ?>
                                                <div class="tab-pane fade <?php if(auth()->user()->role == 'admin'): ?> show active <?php endif; ?>" id="nav-users" role="tabpanel" aria-labelledby="nav-admins-tab" tabindex="0">
                                                     <table class="table table-striped table-bordered">
                                                        <thead>
                                                            <tr>
                                                                <th>Name</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <span class="text-secondary"><?php echo e($user->name); ?></span>
                                                                </td>
                                                                <td>
                                                                    <?php if($user->image): ?>
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/douz/Downloads/projetPFE2/resources/views/profile/user-profile.blade.php ENDPATH**/ ?>