                        ...
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Assign site to device</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h6 class="mb-0 text-uppercase">Assign site device</h6>
                            </div>
                            <hr/>
                            ...
                            <div class="borders rounded">
                                <form class="row g-3" method="POST" action="<?php echo e(url('assign-site-device')); ?>" >
                                    ...
                                    <label class="form-label" for="device_ids">Devices</label>
                                    <select class="multiple-select" name="device_ids[]" id="device_ids" data-placeholder="Choose anything" multiple="multiple">
                                        <option value="0" selected> select device </option>
                                        <?php $__currentLoopData = $deviceTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $device): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/douz/Downloads/projetPFE2/resources/views/device_site/assigne_sito_to_devices.blade.php ENDPATH**/ ?>