    ...
    height: 350px;
                     ...
                     <div class="page-wrapper">
                        <div class="page-content">
                                ...
                                <div class="ps-3">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0 p-0">
                                            <li class="breadcrumb-item"><a href="<?php echo e(url()->previous()); ?>"><i class="bx bx-home-alt"></i></a></li>
                                        </ol>
                                    </nav>
                                </div>
                                ...
                                <form method="GET" action="<?php echo e(route('dashboard')); ?>">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-select" name="selectedSiteId" id="site">
                                            ...
                                            <?php $__currentLoopData = $sites_admin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <?php if($selectedSiteId): ?>
                                                        <p class="mb-0">Site :</p>
                                                        <p class="mb-0"><?php echo e($selectedSite->location); ?></p>
                                                    <?php else: ?>
                                                        <p class="mb-0">Total site :</p>
                                                        <h5 class="mb-0"><?php echo e($sites_count); ?></h5>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="ms-auto">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <?php if($selectedSiteId): ?>
                                                        ...
                                                        <p class="mb-0"><?php echo e($users_select_count); ?></p>
                                                    <?php else: ?>
                                                        <p class="mb-0">Total users :</p>
                                                        <h5 class="mb-0"><?php echo e($users_count); ?></h5>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="ms-auto">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <?php if($selectedSiteId): ?>
                                                        ...
                                                        <p class="mb-0"><?php echo e($devices_select_count); ?></p>
                                                    <?php else: ?>
                                                        <p class="mb-0">Total devices :</p>
                                                        <h5 class="mb-0"><?php echo e($devices_count); ?></h5>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="ms-auto">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <?php if($selectedSiteId): ?>
                                                        ...
                                                        <p class="mb-0"><?php echo e($gateways_select_count); ?></p>
                                                    <?php else: ?>
                                                        <p class="mb-0">Total gateways</p>
                                                        <h5 class="mb-0"><?php echo e($gateways_count); ?></h5>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="ms-auto">
                            ...
                            <?php if($temperatureData !== null && array_key_exists('temp', $temperatureData)): ?>
                            <div class="row">
                                            ...
                                            <div class="d-flex align-items-start justify-content-between">
                                                <div>
                                                    <div class="average">
                                                        ...
                                                        <h4><?php echo e($temperatureData['dailyAverages']['averageHumidity'] ?? 'N/A'); ?></h4>
                                                    </div>
                                                    <div style="margin-top: 50px;"></div>
                                                    <div class="average">
                                                        <p class="mb-0">Moyenne Temperature today:</p>
                                                        <h4><?php echo e($temperatureData['dailyAverages']['averageTemp'] ?? 'N/A'); ?></h4>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        ...
                                                        <h4 class="my-1"><?php echo e($temperatureData['dailyAverages']['temperatureStatus'] ?? 'N/A'); ?></h4>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        ...
                                                        <h4 class="my-1"><?php echo e($temperatureData['dailyAverages']['humidityStatus'] ?? 'N/A'); ?></h4>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        ...
                                                        <h4 class="my-1"><?php echo e($temperatureData['dailyAverages']['powerStatus'] ?? 'N/A'); ?></h4>
                            ...
                            <div class="card radius-10">
                                <div class="card-body">
                                    ...
                                    <?php if(auth()->user()->role == 'admin'): ?>
                                        <div>
                                            <h6 class="mb-0">Users Added by <?php echo e(auth()->user()->name); ?></h6>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table align-middle mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if($user->image): ?>
                                                            <img src="<?php echo e(asset('storage/' . $user->image)); ?>" class="user-img" alt="user avatar">
                                                        <?php else: ?>
                                                        <img src="assets/images/user.png" class="user-img" alt="Default Avatar">
                                                        <?php endif; ?>
                                                    </td>
                                                    <td><?php echo e($user->email); ?></td>
                                                    <?php if($user->site->location): ?>
                                                        <td><?php echo e($user->site->location); ?></td>
                                                    <?php else: ?>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                                <div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h6 class="mb-0"><?php echo e(auth()->user()->name); ?>'s Users</h6>
                                        </div>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table align-middle mb-0">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $users_super_admin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($admin->name); ?></td>
                                                    <td>
                                                        
                                                     <?php if($admin->image): ?>
                                                    <img src="<?php echo e(asset('storage/' . $admin->image)); ?>" class="user-img" alt="user avatar">
                                                    <?php else: ?>
                                                    <img src="assets/images/user.png" class="user-img" alt="Default Avatar">
                                                    <?php endif; ?>
                                                    </td>
                                                    ...
                                                    <td><?php echo e($admin->added_by_name); ?></td>
                            ...
                            <?php if($waterLevels !== null && array_key_exists('data', $waterLevels)): ?>
                            <div class="row">
                        ...
                        <?php if($gpsData !== null && array_key_exists('latitude', $gpsData)): ?>
...
<?php $__env->stopSection(); ?>
  ...
  <div id="map"></div>
  <script>
      var latitude = <?php echo e($selectedSite->latitude); ?>;
      var longitude = <?php echo e($selectedSite->longitude); ?>;
...
<?php if($gpsData !== null ): ?>
  ...
  <script>
      ...
      var gpsData = <?php echo json_encode($gpsData); ?>;
...
<?php endif; ?>
            <?php if($waterLevels !== null && array_key_exists('data', $waterLevels)): ?>
                 <script>
                    var waterLevelsData = <?php echo json_encode($waterLevels); ?>;
            ...
            var waterLevelsOptions = {
                ...
                series: [{
                    name: 'Water Level',
                    data: <?php echo json_encode($waterLevels['data']); ?>,
                }],
                markers: {
                    size: 4,
                    strokeWidth: 0,
                ...
                labels: <?php echo json_encode($waterLevels['labels']); ?>,
                xaxis: {
                    tooltip: {
                        enabled: false
                    }
            ...
            var temperatureOptions = {
                ...
                series: [{
                    name: "Temperature",
                    data: <?php echo json_encode($temperatureData['temp']); ?>

                }, {
                    name: "Humidity",
                    data: <?php echo json_encode($temperatureData['humidity']); ?>
                ...
                labels: <?php echo json_encode($temperatureData['labels']); ?>,
                xaxis: {
                    tooltip: {
                        enabled: false
                    }
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/douz/Downloads/projetPFE2/resources/views/dashboard.blade.php ENDPATH**/ ?>