                             ...
                             @endif
                                    ...
                                    <div class="table-responsive mt-3">
                                        ...
                                        @foreach($users as $user)
                                                ...
                                                <td> 
                                                    <div class="d-flex align-items-center">
                                                        <a class="btn btn-sm btn-primary" href="{{ url('edit-user/'.$user->id) }}" ><i class='bx bx-edit-alt me-0'></i></a>
                                                        &nbsp;&nbsp;
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form id="deleteForm{{ $user->id }}" action="{{ url('destroy-user/'.$user->id) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
