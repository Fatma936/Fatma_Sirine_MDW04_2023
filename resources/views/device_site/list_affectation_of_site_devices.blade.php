                                ...
                                <div class="table-responsive mt-3">
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                @if($site->device_id == "ffffff100000b745")
                                                AN-103A Temp/Humidity Sensor
                                                @elseif ($site->device_id == "ffffff100000c836")
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body"> Are you sure you want to delete site associated to:
                                                                    <br/>{{ ucfirst($site->device_id) }} ?</div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cancel</button>
                                                                    <form id="deleteForm{{ $site->id }}" action="{{ url('destroy-record-device',$site->id ) }}" method="POST" >
                                                                        @csrf
                                                                        @method('DELETE')
