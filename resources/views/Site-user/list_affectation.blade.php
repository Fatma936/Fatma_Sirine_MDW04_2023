                                ...
                                <div class="table-responsive mt-3">
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a class="btn btn-sm btn-primary" href="{{ url('edit-site-admin/'.$site->id) }}"><i class='bx bx-edit-alt me-0'></i></a>
                                                    &nbsp;&nbsp;
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body"> Are you sure you want to delete this site associated to:
                                                                    <br/>{{ ucfirst($site->admin_names) }} ?</div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cancel</button>
                                                                    <form id="deleteForm{{ $site->id }}" action="{{ url('destroy-record/'.$site->site_id) }}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
