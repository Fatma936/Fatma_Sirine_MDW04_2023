                ...
                <div class="page-content">
                    ...
                    <div class="table-responsive mt-3">
                                        ...
                                        @foreach($sites as $site)
                                                ...
                                                <td> 
                                                    <div class="d-flex align-items-center">
                                                        <a class="btn btn-sm btn-primary" href="{{ url('edit-site/'.$site->id) }}"><i class='bx bx-edit-alt me-0'></i></a>
                                                        &nbsp;&nbsp;
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body"> Are you sure you want to delete {{ ucfirst($site->location) }} ?</div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cancel</button>
                                                            <form id="deleteForm{{ $site->id }}" action="{{ url('destroy-site/'.$site->id) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
