                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                                    <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32"><path fill="none" d="M18.303 9a2.662 2.662 0 0 0-1.908.806l-.393.405l-.397-.405a2.662 2.662 0 0 0-3.816 0a2.8 2.8 0 0 0 0 3.896L16.002 18l4.209-4.298a2.8 2.8 0 0 0 0-3.896A2.662 2.662 0 0 0 18.303 9Z"/><path fill="#ea4335" d="M16 2A11.013 11.013 0 0 0 5 13a10.889 10.889 0 0 0 2.216 6.6s.3.395.349.452L16 30l8.439-9.953c.044-.053.345-.447.345-.447l.001-.003A10.885 10.885 0 0 0 27 13A11.013 11.013 0 0 0 16 2Zm4.21 11.702L16.003 18l-4.213-4.298a2.8 2.8 0 0 1 0-3.896a2.662 2.662 0 0 1 3.816 0l.397.405l.393-.405a2.662 2.662 0 0 1 3.816 0a2.8 2.8 0 0 1 0 3.896Z"/></svg>&nbsp; Site</h6>
                                                    @if ( $site )
                                                    <span class="text-secondary">{{ $site }}</span>
                                                    @else
                                                    <span class="text-secondary">No site yet</span>
                                                    @endif
                                                </li>
                                                @endif
                                            </ul>
                                                    ...
                                                    <table class="table table-striped table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @if ($admin->image)
                                                                    <img src="{{ $admin->image }}" class="user-img" alt="user avatar">
                                                                    @else
                                                                ...
                                                                <td>
                                                                    @if( $site == null)
                                                                    <span class="text-secondary">not assigned to site yet</span>
                                                                    @else
                                                                    <span class="text-secondary">{{ $site->location }}</span>
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                    @php
